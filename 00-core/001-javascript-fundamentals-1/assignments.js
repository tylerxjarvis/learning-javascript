...
// let description = country + ' is in ' + continent + ', and its ' + population + ' people speak ' + language + '.'; // define the statement as a temporary variable
...
//     console.log(`${country}'s population is ${population - averagePopulation} above the average!`)
// } else {
...
// const numNeighbors = prompt('Howm any neighbor countries does your country have?');
...
const higherPopulation = population > averagePopulation ? `${country}'s population is above average!` : `${country}'s population is below average!`; // ternary operator
